...
loginForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    */
    ...
    if (data.acesso === true) {
      mensagemSucesso.textContent = data.mensagem || 'Login realizado com sucesso.';
      ...
      mensagemErro.textContent = data.mensagem || 'E-mail ou senha inválidos.';
    }

  } catch (error) {
    console.error('Erro no login:', error);
    mensagemErro.textContent = 'Não foi possível fazer login agora. Tente novamente.';
  } finally {
